        ...
        try {
            switch (command) {   
                ...
                case 'alive': {
                    ...
                    const title = 'HASITHA 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 𝐀𝐋𝐈𝐕𝐄 𝐍𝐎𝐖 😾❤*';
                    const content = `*ʜ ᴀ ꜱ ɪ ᴛ ʜ ᴀ ᴍɪɴɪ ʙᴏᴛ ᴠ1*\n` +                                   `*ʙᴏᴛ ᴏᴡɴᴇʀ :- ʜ ᴀ ꜱ ɪ ᴛ ʜ ᴀ ᴍɪɴɪ ʙᴏᴛ ᴠ1*\n` +
                                `*ʙᴏᴛ ɴᴀᴍᴇ :- ʜ ᴀ ꜱ ɪ ᴛ ʜ ᴀ  ᴍɪɴɪ ʙᴏᴛ ᴠ1*\n` +
                                   `*ʙᴏᴛ ᴡᴇʙ ꜱɪᴛᴇ*\n` +
                                   `> *ᴄᴏᴍɪɴɢ ꜱᴏᴏɴ*`;
...
case 'menu': {
    ...
    const title = 'HASITHA 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 𝐌𝐄𝐍𝐔 😾❤*';
    const text = `╭──➢\n` +
        `│ \`S T A T U S\`\n` +
        `│ *⦁ ʙᴏᴛ ɴᴀᴍᴇ*: ʏᴏᴠɪ ᴍɪɴɪ ʙᴏᴛ\n` +
        `│ *⦁ ʙᴏᴛ ᴏᴡɴᴇʀ*: ʜ ᴀ ꜱ ɪ ᴛ ʜ ᴀ ᴍɪɴɪ ʙᴏᴛ\n` +
        `│ *⦁ ᴠᴇʀꜱɪᴏɴ*: 0.0001+\n` +
        `│ *⦁ ᴘʟᴀᴛꜰᴏᴇᴍ*: Heroku\n` +
...
//=======================================
                ...
                case 'owner': {
                    const vcard = 'BEGIN:VCARD\n'
                        ...
                        + 'FN:SHALA OWNER\n'
                        + 'ORG:SHALA OWNER\n'
                        + 'TEL;type=CELL;type=VOICE;waid=94705846788:+94705846788\n'
                        + 'EMAIL:shalamd@gmail.com\n'
                        + 'END:VCARD';

                    await socket.sendMessage(sender, {
                        contacts: {
                            displayName: " © ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʟ ᴏ ᴋ ᴜ  ʜ ᴀ ꜱ ɪ ᴛ ʜ ᴀ OWNER",
                            contacts: [{ vcard }]
                        },
                        image: { url: config.BUTTON_IMAGES.OWNER },
                        caption: '*👨‍💻 HASITHA BOT OWNER DETAILS*',
                        buttons: [
                            { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: '📋 MENU' }, type: 1 },
                ...
                case 'song': {
                    try {
                        ...
                        const titleText = '*HASITHA SONG DOWNLOAD*';
                        const content = `┏━━━━━━━━━━━━━━━━\n` +
                            `┃📝 \`Title\` : ${video.title}\n` +
                            `┃📈 \`Views\` : ${video.views}\n` +
